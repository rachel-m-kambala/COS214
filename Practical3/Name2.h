/**
 * @file Name2.h
 * @brief Concrete User implementation for a user named "Name2".
 * 
...
/**
 * @class Name2
 * @brief Concrete user named "Name2" participating in chat rooms.
 *
...
public:
    /**
     * @brief Constructs a Name2 user with the name "Name2".
     */
    Name2() : User("Name2") {}
